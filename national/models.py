...
class SordNationalAuditTrail(models.Model):
    ...
    quantity = models.DecimalField(max_digits=10, decimal_places=2, default=0.00)
    price = models.DecimalField(max_digits=10, decimal_places=2, default=0.00)
    initial_quantity = models.DecimalField(max_digits=10, decimal_places=2, default=0.00)
    quantity_allocated = models.DecimalField(max_digits=10, decimal_places=2, default=0.00)
    end_quantity = models.DecimalField(max_digits=10, decimal_places=2, default=0.00)
...
class DepotFuelUpdate(models.Model):
    ...
    usd_petrol = models.DecimalField(max_digits=10, decimal_places=2, default=0.00)
    usd_diesel = models.DecimalField(max_digits=10, decimal_places=2, default=0.00)
    rtgs_petrol = models.DecimalField(max_digits=10, decimal_places=2, default=0.00)
    rtgs_diesel = models.DecimalField(max_digits=10, decimal_places=2, default=0.00)
