...
class Subsidiaries(models.Model):
    ...
    is_usd_active = models.BooleanField(default=False)
...
class Transaction(models.Model):
    ...
    def get_delivery_schedule(self):
        return DeliverySchedule.objects.filter(transaction__id=self.id).first()
...
class SordSubsidiaryAuditTrail(models.Model):
    ...
    subsidiary = models.ForeignKey(Subsidiaries, on_delete=models.CASCADE, related_name='subsidiary_sord')
