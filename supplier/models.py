...
class SuballocationFuelUpdate(models.Model):
    ...
    petrol_quantity = models.DecimalField(max_digits=10, decimal_places=2, default=0.00)
    diesel_quantity = models.DecimalField(max_digits=10, decimal_places=2, default=0.00)
