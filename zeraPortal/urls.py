...
urlpatterns = [
    ...
    path('ministry_statements/', views.ministry_statements, name='ministry_statements'),
    ...
    path('sub_comments/<int:id>', views.sub_comments, name='sub_comments'),
    ...
    path('site_applications/',views.site_applications, name='site_applications')
