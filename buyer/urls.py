...
urlpatterns = [
    ...
    path('download-application/<int:user_id>', views.download_application, name='download-application'),
    path('upload-application/<int:user_id>', views.upload_application, name='upload-application'),
    ...
    path('transaction_review/delete/<int:user_id>', views.transactions_review_delete, name='tran-review-delete'),
    path('transaction_review/edit/<int:user_id>', views.transaction_review_edit, name='tran-review-edit'),
    ...
    path('delivery-schedule/<int:user_id>', views.delivery_schedule, name="delivery-schedule"),
    path('proof-of-payment/<int:user_id>', views.proof_of_payment, name="proof-of-payment"),
